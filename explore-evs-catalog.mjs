...
export const TOP_12_EVS = Object.freeze([
  // --- ELECTRIC CARS (4) ---
  {
    ...
    badge: 'Trending SUV',
    realImage: '/showroom-assets/cars/punch-ev/images/frame-00.jpg',
    priceMinLakh: 9.99,
    priceMaxLakh: 14.44,
    claimedRangeKm: 421,
...
Speak warmly, informatively, and concisely in English, Hindi, or Hinglish.`
  },
  {
    ...
    category: 'Electric car',
    badge: 'India’s #1 EV',
    realImage: '/showroom-assets/cars/nexon-ev-carwale/exterior/frame-00.jpg',
    priceMinLakh: 12.49,
    priceMaxLakh: 17.19,
    claimedRangeKm: 489,
...
Speak warmly, informatively, and concisely in English, Hindi, or Hinglish.`
  ...
  // --- ELECTRIC SCOOTERS (4) ---
  {
    ...
    realImage: '/showroom-assets/bikes/ather-rizta/exterior/frame-00.jpg',
    priceMinLakh: 1.10,
    priceMaxLakh: 1.49,
    claimedRangeKm: 159,
...
Speak warmly, informatively, and concisely in English, Hindi, or Hinglish.`
  },
  {
    ...
    name: 'King Kargo HD EV',
    company: 'TVS Motor Company',
    category: 'Electric 3-wheeler',
    badge: 'Electric Cargo Carrier',
    realImage: '/showroom-assets/three-wheelers/king-kargo-ev-hd/white/fixed-side-deck/frame-00.webp',
    priceMinLakh: 3.95,
    priceMaxLakh: 4.25,
    claimedRangeKm: 156,
    realWorldRangeKm: '130–145 km (Loaded)',
    battery: '8.9 kWh (LFP Battery)',
    charging: '3 h 10 min (0–100% 3kW Charge)',
    power: '11.2 kW / 40 Nm Torque',
    acceleration: 'Top Speed: 60 km/h',
    topSpeed: '60 km/h',
    bootSpace: 'Fixed Side Deck / Container Body',
    groundClearance: '235 mm',
    warranty: '5 Years / 1,00,000 km Warranty',
    features: ['Eco, City and Power Drive Modes', '4 Cargo Body Configurations', 'Connected Fleet & Navigation', '235mm Ground Clearance'],
    pros: ['Heavy-duty 998 kg GVW', '235mm class-leading ground clearance', 'Fast 3h 10m charging time', 'Backed by TVS pan-India service network'],
    cons: ['Commercial cargo layout', 'Top speed 60 km/h'],
    color3D: 0x1a365d,
    secondaryColor3D: 0xffffff,
    modelType: 'threewheeler',
    knowledgePrompt: `You are the dedicated vehicle expert for the TVS King Kargo HD EV three-wheeler by TVS Motor Company. Certified range is 156 km with 8.9 kWh LFP battery, 60 km/h top speed, and 235 mm ground clearance. Speak warmly and informatively in English, Hindi, or Hinglish.`
  },
  {
    id: 'mg-comet-ev',
    name: 'Comet EV',
    ...
    category: 'Electric car',
    badge: 'Urban Electric Hatch',
    realImage: '/showroom-assets/cars/comet-ev-carwale/exterior/frame-00.jpg',
    priceMinLakh: 6.99,
    priceMaxLakh: 9.49,
    claimedRangeKm: 230,
    realWorldRangeKm: '160–190 km (City AC)',
    battery: '17.3 kWh (Prismatic Li-Ion IP67)',
    charging: '3.5 hrs (10-80% 3.3kW AC)',
    power: '42 PS / 110 Nm',
    acceleration: '0-60 km/h in 5.5s',
    topSpeed: '101 km/h',
    bootSpace: 'Rear Folding Seats Luggage Area',
    groundClearance: '165 mm',
    warranty: '8 Years / 1,20,000 km Battery Warranty',
    features: ['Dual 10.25" Floating Panoramic Screens', 'Compact 4.2m Turning Radius', 'Wireless Apple CarPlay & Android Auto', 'Smart Key with Keyless Walk-Away Lock'],
    pros: ['Ultra-easy to park and navigate through dense city traffic', 'Low starting price under ₹7 Lakh', 'Modern twin 10.25-inch infotainment screens', 'Very low operating cost (~ ₹0.60/km)'],
    cons: ['Strictly 4-seater with limited boot space when rear seats are up', 'No DC fast charging'],
    color3D: 0x00c9ff,
    secondaryColor3D: 0x111111,
    modelType: 'hatchback',
    knowledgePrompt: `You are the dedicated vehicle expert for the MG Comet EV by JSW MG Motor India. 17.3 kWh battery, 230 km claimed range, 42 PS power, ideal for city mobility. Speak warmly and informatively in English, Hindi, or Hinglish.`
  }
]);
